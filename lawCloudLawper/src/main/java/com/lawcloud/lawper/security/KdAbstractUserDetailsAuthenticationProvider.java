...
public abstract class KdAbstractUserDetailsAuthenticationProvider implements AuthenticationProvider, InitializingBean,
        MessageSourceAware {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        Assert.isInstanceOf(KdUsernamePasswordAuthenticationToken.class, authentication,
                messages.getMessage("KdAbstractUserDetailsAuthenticationProvider.onlySupports",
                        "Only KdUsernamePasswordAuthenticationToken is supported"));
        ...
        if (user == null) {
            ...
            try {
                user = retrieveUser(username, (KdUsernamePasswordAuthenticationToken) authentication);
        ...
        try {
            ...
            additionalAuthenticationChecks(user, (KdUsernamePasswordAuthenticationToken) authentication);
    ...
    protected Authentication createSuccessAuthentication(Object principal, Authentication authentication,
        ...
        KdUsernamePasswordAuthenticationToken result = new KdUsernamePasswordAuthenticationToken(principal,
                authentication.getCredentials(), "2", authoritiesMapper.mapAuthorities(user.getAuthorities()));
     ...
     */
    protected abstract UserDetails retrieveUser(String username, KdUsernamePasswordAuthenticationToken authentication)
            throws AuthenticationException;
